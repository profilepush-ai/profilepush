-- Generic authenticated credit consumption RPC for feature-gated actions.
-- This keeps deductions atomic (balance update + ledger write) and reusable from UI.
...
BEGIN
  ...
  VALUES (
    ...
    'usage',
    -v_amount,
    CONCAT('Pulse: ', COALESCE(NULLIF(TRIM(p_feature), ''), 'feature action'))
  );
