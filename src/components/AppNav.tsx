...
export default function AppNav() {
  ...
  return (
    ...
    <header className="min-h-12 bg-white flex items-center px-3 sm:px-4 gap-3 sm:gap-6 shrink-0 z-50 pt-[env(safe-area-inset-top)]">
      ...
      {user && (
        <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-gray-200 bg-white pb-[calc(env(safe-area-inset-bottom)+8px)] sm:hidden">
          <Link
            to="/jobs"
