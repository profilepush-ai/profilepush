      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-10">
          ...
          <Section title="4. Billing, AI Credits, and Subscriptions">
            <p><strong>Free plan:</strong> Every new account receives 100 AI credits, granted once at signup, which never expire and are not refreshed on any recurring schedule. Two one-off bonuses of 10 credits each are granted automatically the first time you publish a post and the first time you send a submission. No credit card is required, and every feature of the Platform is accessible on the Free plan.</p>
