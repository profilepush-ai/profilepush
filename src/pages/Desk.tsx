...
export default function Dashboard() {
  ...
  if (loading) {
    return (
      <div className="h-[100dvh] flex flex-col bg-gray-50 overscroll-none pb-[calc(4.5rem+env(safe-area-inset-bottom))] sm:pb-0">
        <AppNav />
  ...
  // ─── Render ────────────────────────────────────────────────────────────────
  return (
    <div className="h-[100dvh] flex flex-col bg-gray-50 font-sans overflow-hidden overscroll-none pb-[calc(4.5rem+env(safe-area-inset-bottom))] sm:pb-0">
      <AppNav />
